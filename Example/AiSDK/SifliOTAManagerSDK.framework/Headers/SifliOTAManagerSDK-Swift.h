...
SWIFT_CLASS("_TtC18SifliOTAManagerSDK17OtaQBleLogManager")
@interface OtaQBleLogManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OtaQBleLogManager * _Nonnull share;)
+ (OtaQBleLogManager * _Nonnull)share SWIFT_WARN_UNUSED_RESULT;
